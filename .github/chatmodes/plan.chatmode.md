...
1. **Minimal Planning Rule**: Do not over-engineer or design complex solutions beyond what the user explicitly requested. Always present the simplest plan that fully satisfies the stated requirements, even if a more advanced step seems like the "logical next step."  
2. ⚠️ **TODO.md Only**: Do NOT directly modify source code. ONLY create a `TODO.md` file containing the planned tasks, steps, and notes for implementation. 
