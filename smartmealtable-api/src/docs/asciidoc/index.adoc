...
include::{snippets}/auth/login/email/invalid-credentials/http-response.adoc[]

include::{snippets}/auth/login/email/invalid-credentials/response-fields.adoc[]
...
include::{snippets}/auth/login/kakao/success/request-fields.adoc[]

==== 성공 응답 (200 OK)

include::{snippets}/auth/login/kakao/success/http-response.adoc[]

===== 응답 필드

include::{snippets}/auth/login/kakao/success/response-fields.adoc[]
...
include::{snippets}/auth/login/google/success/http-request.adoc[]

===== 요청 필드

include::{snippets}/auth/login/google/success/request-fields.adoc[]

==== 성공 응답 (200 OK)

include::{snippets}/auth/login/google/success/http-response.adoc[]

===== 응답 필드

include::{snippets}/auth/login/google/success/response-fields.adoc[]
...
include::{snippets}/members/update-profile/fail-duplicate-nickname/http-response.adoc[]

include::{snippets}/members/update-profile/fail-duplicate-nickname/response-fields.adoc[]
...
include::{snippets}/members/change-password/fail-wrong-current-password/http-response.adoc[]

include::{snippets}/members/change-password/fail-wrong-current-password/response-fields.adoc[]

===== 유효성 검증 실패 (422 Unprocessable Entity)

include::{snippets}/members/change-password/fail-validation-error/http-response.adoc[]

include::{snippets}/members/change-password/fail-validation-error/response-fields.adoc[]
...
include::{snippets}/members/withdraw/fail-wrong-password/http-response.adoc[]

include::{snippets}/members/withdraw/fail-wrong-password/response-fields.adoc[]
...
include::{snippets}/onboarding-foods-get/success/http-request.adoc[]

===== 요청 헤더

include::{snippets}/onboarding-foods-get/success/request-headers.adoc[]

==== 성공 응답 (200 OK)

include::{snippets}/onboarding-foods-get/success/http-response.adoc[]

===== 응답 필드

include::{snippets}/onboarding-foods-get/success/response-fields.adoc[]
...
include::{snippets}/onboarding-food-preferences-post/success/http-request.adoc[]

===== 요청 헤더

include::{snippets}/onboarding-food-preferences-post/success/request-headers.adoc[]

===== 요청 필드

include::{snippets}/onboarding-food-preferences-post/success/request-fields.adoc[]

==== 성공 응답 (201 Created)

include::{snippets}/onboarding-food-preferences-post/success/http-response.adoc[]

===== 응답 필드

include::{snippets}/onboarding-food-preferences-post/success/response-fields.adoc[]
...
include::{snippets}/expenditure/parse-sms-success/request-headers.adoc[]
...
include::{snippets}/expenditure/get-detail-success/path-parameters.adoc[]
...
include::{snippets}/expenditure/update-success/path-parameters.adoc[]
...
include::{snippets}/expenditure/delete-success/path-parameters.adoc[]
...
include::{snippets}/recommendation-list-success-default/query-parameters.adoc[]
...
include::{snippets}/recommendation-type-update-success/query-parameters.adoc[]
...
include::{snippets}/map/search-address/request-headers.adoc[]
...
include::{snippets}/map/reverse-geocode/request-headers.adoc[]
...
include::{snippets}/app-settings/get/request-headers.adoc[]
