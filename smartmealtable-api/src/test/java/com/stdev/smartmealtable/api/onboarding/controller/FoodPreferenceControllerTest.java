...
class FoodPreferenceControllerTest extends AbstractContainerTest {
    ...
    void setUp() {
        ...
        Food food4 = Food.reconstitute(null, "비빔밥", savedStore.getStoreId(), categoryId1, "영양만점 비빔밥", "https://example.com/bibimbap.jpg", 9000);
        Food food5 = Food.reconstitute(null, "짜장면", savedStore.getStoreId(), categoryId2, "달콤한 짜장면", "https://example.com/jjajang.jpg", 6000);
        Food food6 = Food.reconstitute(null, "짬뽕", savedStore.getStoreId(), categoryId2, "얼큰한 짬뽕", "https://example.com/jjamppong.jpg", 7000);
        Food food7 = Food.reconstitute(null, "탕수육", savedStore.getStoreId(), categoryId2, "바삭한 탕수육", "https://example.com/tangsuyuk.jpg", 18000);
        Food food8 = Food.reconstitute(null, "삼겹살", savedStore.getStoreId(), categoryId1, "고소한 삼겹살", "https://example.com/samgyeopsal.jpg", 15000);
        Food food9 = Food.reconstitute(null, "김밥", savedStore.getStoreId(), categoryId1, "간편한 김밥", "https://example.com/gimbap.jpg", 3000);
        Food food10 = Food.reconstitute(null, "라면", savedStore.getStoreId(), categoryId1, "매운 라면", "https://example.com/ramyeon.jpg", 4000);
