...
import com.stdev.smartmealtable.admin.policy.service.dto.UpdatePolicyServiceRequest;
...
public record UpdatePolicyRequest(
    ...
    public UpdatePolicyServiceRequest toServiceRequest() {
        return new UpdatePolicyServiceRequest(
                title,
                content,
                type,
                version,
